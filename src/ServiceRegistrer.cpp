...
#include <arpa/inet.h>
/**
 * Register new service if such does not exist
 * @param serviceRecord
 */
...
/**
 * Unregister the service serviceRecord
 * @param serviceRecord
 */
...
/**
 * Encapsulate the service registering idiom of bluez library
 * @param serviceRecord
 * @return sdp_record_t to be used for future unregistering
 */
